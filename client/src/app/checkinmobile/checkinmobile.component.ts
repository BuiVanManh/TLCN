...
@Component({
  selector: 'app-checkinmobile',
  templateUrl: './checkinmobile.component.html',
  styleUrls: ['./checkinmobile.component.css']
})
export class CheckinMobileComponent implements OnInit {
  event;
  idEvent;
